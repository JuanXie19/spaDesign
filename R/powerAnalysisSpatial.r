...
#' # n_rep <- 10
#' # results <- powerAnalysisSpatial(spadesign, prop_range, seq_depth_range, n_rep, conda_env_path) 
#' @export

library(parallel)

powerAnalysisSpatial <- function(spadesign, prop_range, seq_depth_range, n_rep, conda_env_path) {
    ...
    process_row <- function(row) {
        ...
        DATA <- simulateDataSpatial(spadesign, seq_depth_factor, SIGMA, SEED, prop)
